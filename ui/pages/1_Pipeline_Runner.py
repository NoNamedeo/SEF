...
Layout:
  ...
  Tab 1       ROI / Barriere  (overlay interattivo)
...
with st.sidebar:
    ...
    stride = st.slider("Stride frame", 1, 10, 2, key="pr_stride", help="Analizza 1 frame ogni N.")
...
# ═════════════════════════════════════════════════════════════════════════════
# VIDEO SELECTION — always above the tabs so the frame is ready for the overlay editor
# ═════════════════════════════════════════════════════════════════════════════
...
with tab_roi:
    ...
    if mode == "Multi oggetto + barriere":
        ...
        n_barriers = st.number_input("Numero di barriere", min_value=1, max_value=6, value=2, key="pr_n_barriers")
        ...
        last_barrier_names_key = "pr_last_barrier_names"
